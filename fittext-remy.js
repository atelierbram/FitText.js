  ...
  for (; i < length; i++) {
    (function (el) {
      ...
      var resizer = function () {
        var width = parseFloat(el.clientWidth);
...
// http://jsbin.com/eberan/9/edit
// http://remysharp.com/2013/04/19/i-know-jquery-now-what/
window.fitText(document.getElementById('fittext1'));
window.fitText(document.getElementById('fittext2'), 1.2);
window.fitText(document.getElementById('fittext3'), 1.1, { minFontSize: '50px', maxFontSize: '75px' });
